...
const galleryItems = [
  {
    ...
    image: '/img/portfolio/tout/command-center-search-400.png',
    label: 'React',
  ...
  },
  {
    ...
    image: '/img/portfolio/tout/campaign-setup-narrow-400.png',
    label: 'React',
    link: '/portfolio#marketo',
  ...
  {
    categories: [GalleryItemIds.react],
    image: '/img/portfolio/tout/campaign-tasks-add-people-400.png',
    label: 'React',
    link: '/portfolio#marketo',
  ...
  {
    categories: [GalleryItemIds.react, GalleryItemIds.web],
    image: '/img/portfolio/personal/2019-home-400.png',
  ...
  },
  {
    ...
    image: '/img/portfolio/leap/quote-400.png',
    label: 'Vue & Nuxt',
  ...
  {
    categories: [GalleryItemIds.vue],
    image: '/img/portfolio/leap/quote-options-400.png',
    label: 'Vue & Nuxt',
    link: '/portfolio#leaplife',
  ...
  },
  {
    ...
    image: '/img/portfolio/leap/blog-index-400.png',
    label: 'Vue & Nuxt',
    link: '/portfolio#leaplife',
  ...
  },
  {
    ...
    image: '/img/portfolio/personal/2017-tout-400.png',
  ...
  {
    categories: [GalleryItemIds.web],
    image: '/img/portfolio/coyote/web-login-400.png',
  ...
  {
    categories: [GalleryItemIds.web],
    image: '/img/portfolio/coyote/web-recommended-loads-400.png',
    label: 'Coyote Logistics',
    link: '/portfolio#coyote',
  ...
  },
  {
    ...
    image: '/img/portfolio/coyote/go-login-graphic-400.png',
    imageLabel: 'CoyoteGO',
  ...
  {
    categories: [GalleryItemIds.mobile],
    image: '/img/portfolio/coyote/go-load-graphic-400.png',
    imageLabel: 'CoyoteGO',
    label: 'Driver Check-in App',
    link: '/portfolio#coyote',
    subtitle: 'PhoneGap & Web',
  ...
  {
    categories: [GalleryItemIds.mobile],
    image: '/img/portfolio/coyote/bazmo-employee-graphic-400.png',
    imageLabel: 'BazMo',
    label: 'Employee App',
    link: '/portfolio#coyote',
  ...
  },
  {
    ...
    image: '/img/portfolio/extensions/gmail-tx-templates-400.png',
  ...
  },
  {
    ...
    image: '/img/portfolio/extensions/gmail-rx-tasks-400.png',
    label: 'Chrome Extension',
    link: '/portfolio#toutapp',
  ...
  {
    categories: [GalleryItemIds.react, GalleryItemIds.extensions],
    image: '/img/portfolio/extensions/owa-tx-meetings-templates-400.png',
    label: 'OWA Extension',
    link: '/portfolio#toutapp',
  ...
  },
  {
    ...
    image: '/img/portfolio/rc/arc-210-400.png',
  ...
  {
    categories: [GalleryItemIds.embedded],
    image: '/img/portfolio/rc/loving-life-400.png',
    label: 'Embedded Radio SW',
    link: '/portfolio#rockwell-collins',
